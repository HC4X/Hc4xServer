  ...
  internal static class GearAndroid {
    ...
    internal static byte[] ParseJPEG(TextureView parTextureView) {
      ...
      try {
        ...
        if (objBitmap.Height > objBitmap.Width)
          iCropY = (objBitmap.Height - objBitmap.Width) / 2;
        objBitmap = Bitmap.CreateBitmap(objBitmap, 0, iCropY / 2, objBitmap.Width, objBitmap.Height - iCropY);
