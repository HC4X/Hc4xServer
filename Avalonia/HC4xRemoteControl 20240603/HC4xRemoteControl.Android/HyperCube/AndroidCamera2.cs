...
namespace Android.HyperCube {
  internal class CaptureSession_CB : CameraCaptureSession.StateCallback {
    ...
    public void Close() => ndCamera_CB = default;
    #endregion
  }
  internal class Camera_CB : CameraDevice.StateCallback {
    ...
    private CaptureSession_CB fwSession_CB { get; set; }
    #endregion
    ...
    private void CameraPreview(CameraDevice parCamera) {
      ...
      try {
        ...
        Builder = parCamera.CreateCaptureRequest(CameraTemplate.Preview);
        Builder.AddTarget(objSurface);
        outputs.Add(objSurface);
        parCamera.CreateCaptureSession(outputs, fwSession_CB = new CaptureSession_CB(this), null);
      }
