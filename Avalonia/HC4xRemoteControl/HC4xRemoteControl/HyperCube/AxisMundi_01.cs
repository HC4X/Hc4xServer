...
namespace HyperCube.RemoteControl {
  public class LandLifetime {
    ...
    public virtual string QrCodeDecode() => throw new NotImplementedException();
    public virtual byte[] ScreenShot() => throw new NotImplementedException();
    ...
    protected bool InitFS() {
      ...
      try {
        atBasePath = @"L:\HyperCube\Community\HC4xRemoteControl\LibHC4xAsset";
